...
|-----|--------|-----------|
| BODY_PARAM_MISSING_REQUIRED | 29 | Ein laut OpenAPI-Contract required Body-Feld wird vom Tool nicht als required gesendet — der Aufruf kann am echten Endpunkt fehlschlagen (siehe #142). |
...
## BODY_PARAM_MISSING_REQUIRED (29)
...
|------|------|------|------|-------|
| `activate_license` | POST | `/api/license` | `key` | system.ts:139 |
...
| `set_favorite_groups` | POST | `/api/preferences/favorite-groups` | `action` | users.ts:231 |
| `set_favorites` | POST | `/api/preferences/favorites` | `action` | users.ts:210 |
...
| Tool | HTTP | Pfad | Feld | Datei |
|------|------|------|------|-------|
| `activate_license` | POST | `/api/license` | `licenseKey` | system.ts:139 |
...
| Tool | HTTP | Pfad | Feld | Datei |
|------|------|------|------|-------|
| `create_config_set` | POST | `/api/config-sets` | - | users.ts:269 |
...
| `create_role` | POST | `/api/roles` | - | users.ts:133 |
...
| `set_grid_preferences` | POST | `/api/preferences/grid` | - | users.ts:251 |
...
| `prune_containers` | POST | `/api/prune/containers` | - | system.ts:164 |
